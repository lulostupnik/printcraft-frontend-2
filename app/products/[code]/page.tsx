...
// // // //   const [selectedMediaIndex, setSelectedMediaIndex] = useState<number | null>(0); // Track selected image or STL
...
// // // //   // Determine if selectedMediaIndex is for STL or image
// // // //   const isSTLSelected = selectedMediaIndex === product.images.length;
...
// // // //         {/* Left Column: Images and STL Viewer */}
// // // //         <div className="flex flex-col w-full lg:w-1/3">
// // // //           <div className="bg-white p-4 rounded-lg">
// // // //             {/* Main Media Display */}
// // // //             <div className="mb-4">
// // // //               {isSTLSelected && product.stl_file_url ? (
// // // //                 <div className="w-full h-96 bg-gray-700 rounded">
// // // //                   <StlViewerComponent url={product.stl_file_url} />
// // // //                 </div>
// // // //               ) : (
// // // //                 <img
// // // //                   src={product.images[selectedMediaIndex ?? 0].image_url}
...
// // // //             {/* Thumbnails for Selecting Media */}
...
// // // //                   className={`w-16 h-16 rounded border ${selectedMediaIndex === index ? 'border-blue-500' : 'border-gray-200'} cursor-pointer`}
// // // //                   onClick={() => setSelectedMediaIndex(index)}
// // // //                 />
// // // //               ))}
// // // //               {product.stl_file_url && (
// // // //                 <div
// // // //                   className={`w-16 h-16 bg-gray-700 flex items-center justify-center rounded cursor-pointer ${
// // // //                     isSTLSelected ? 'border-blue-500' : 'border-gray-200'
// // // //                   }`}
// // // //                   onClick={() => setSelectedMediaIndex(product.images.length)}
// // // //                 >
// // // //                   <span className="text-white text-sm">3D View</span>
// // // //                 </div>
// // // //               )}
// // // //             </div>
// // // //           </div>
...
// // //                   src={img.image_url}
// // //                   alt={`Product thumbnail ${index + 1}`}
// // //                   className={`w-16 h-16 rounded border ${selectedImageIndex === index ? 'border-blue-500' : 'border-gray-200'} cursor-pointer`}
