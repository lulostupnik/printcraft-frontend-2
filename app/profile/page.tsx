...
// export default function SellerProductsPage({ userId }: { userId: string }) {
...
//   // Fetch products from the API for a specific seller
//   useEffect(() => {
...
//         <h1 className="text-4xl font-bold mb-8">Productos del Vendedor</h1>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {/* Conditionally render seller's products */}
        {isSeller && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">Productos del Vendedor</h2>
            {loading ? (
