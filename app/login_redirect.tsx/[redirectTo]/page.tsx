  ...
  const fetchUserData = async (accessToken: string) => {
    try {
      ...
      if (userResponse.ok) {
        ...
        // Get redirect URL from the URL params if available
        const redirectTo = searchParams.get('redirectTo');

        // Handle redirection based on the URL param or user role
        setTimeout(() => {
          if (redirectTo) {
            router.push(redirectTo); // Redirect to the specified page in the URL param
