...
//   const [designers, setDesigners] = useState<Designer[]>([]);
//   const [loading, setLoading] = useState(true);
//   const [selectedPage, setSelectedPage] = useState<'designers' | 'auction' | 'myPublications'>('designers');
//   const router = useRouter();
...
//             {/* Add your content here for 'Mis Publicaciones' */}
//             <p>Aquí podrás ver y gestionar tus publicaciones.</p>
//           </section>
//         );
//       default:
...
//             <li>
//               <button
//                 onClick={() => setSelectedPage('designers')}
//                 className={`w-full text-left px-4 py-2 rounded-lg ${
//                   selectedPage === 'designers' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300'
//                 }`}
//               >
//                 Ver Diseñadores
//               </button>
...
//                 className={`w-full text-left px-4 py-2 rounded-lg ${
//                   selectedPage === 'auction' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300'
//                 }`}
//               >
//                 Publicar Subasta Inversa
//               </button>
//             </li>
//             <li>
//               <button
//                 onClick={() => setSelectedPage('myPublications')}
//                 className={`w-full text-left px-4 py-2 rounded-lg ${
//                   selectedPage === 'myPublications' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300'
//                 }`}
//               >
//                 Mis Publicaciones
//               </button>
