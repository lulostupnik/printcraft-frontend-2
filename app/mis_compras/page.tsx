            ...
            <tbody className="divide-y divide-gray-600">
              {products.map((product, index) => (
                <tr key={index} className="hover:bg-gray-800">
                  <td className="px-4 py-2 text-center">{product.orderDate}</td>
                  <td className="px-4 py-2 text-center">{product.quantity}</td>
                  <td className="px-4 py-2 text-center">{product.orderID}</td>
                  <td className="px-4 py-2 text-center">{product.orderDate} €</td>
                  <td className="px-4 py-2 text-center">
                    <a href={`/products/${product.orderDate}`} className="text-blue-500 underline hover:text-blue-700">
                      Ver producto aquí
                    </a>
                  </td>
                </tr>
