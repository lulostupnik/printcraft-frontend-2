...
// //   const [preferenceId, setPreferenceId] = useState<string | null>(null); // Only the preferenceId is needed
// //   const router = useRouter();
// //   const params = useParams(); // Get the params from the URL
// //   const { preferenceId: urlPreferenceId } = params; // Extract 'preferenceId' from params

// //   // Ensure preferenceId is a string (handles string[] case)
// //   useEffect(() => {
// //     if (Array.isArray(urlPreferenceId)) {
// //       setPreferenceId(urlPreferenceId[0]); // Use the first element if it's an array
// //     } else {
...
// //             {urlPreferenceId ? (
// //               <MercadoPagoComponent preferenceId={urlPreferenceId} />
// //             ) : (
...
//       setPreferenceId(urlPreferenceId[0]); // Use the first element if it's an array
//     } else {
//       setPreferenceId(urlPreferenceId ?? null); // Assign null if preferenceId is undefined
//     }
//   }, [urlPreferenceId]);
...
//             {preferenceId ? (
//               <>
//                 <p>Using preference ID: {preferenceId}</p> {/* Log preference ID */}
