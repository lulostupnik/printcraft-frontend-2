...
//   const [isLoading, setIsLoading] = useState(false);
//   const [imagePreviews, setImagePreviews] = useState<string[]>([]);
//   const [message, setMessage] = useState<string | null>(null); // State to store success or error message
...
//     // Ensure at least one image or one STL file is provided
//     if (!productData.stlFile && productData.imageFiles.length === 0) {
//       setMessage("Debe proporcionar al menos una imagen o un archivo STL para publicar el producto.");
//       return;
//     }
