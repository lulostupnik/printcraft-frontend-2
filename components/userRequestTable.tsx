...
//   title: string;
//   requests: PrintRequestUser[];
//   type: 'pending' | 'quoted' | 'delivered' | 'accepted-accepted-finalized';
//   isExpanded: boolean;
//   onExpand: () => void;
//   priceInputs?: { [key: number]: string };
//   handleAcceptRequest?: (requestID: number) => void;
...
//                     {/* Display status dynamically for accepted-finalized */}
//                     {(type === 'accepted-finalized') && (
//                       <td className="px-4 py-2 text-center">
//                         {request.status === 'Realizada' ? 'Lista para ser buscada':'Esperando al vendedor'}
//                       </td>
//                     )}
